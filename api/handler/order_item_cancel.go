...
func PutOrderItemCancel(token string, req *models.OrderItemCancelRequest) (*models.OrderItemCancelResponse, error) {
	...
	var orderItemCancelResp models.OrderItemCancelResponse
